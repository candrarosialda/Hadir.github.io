<?php
	...
	<html lang="id-ID" xml:lang="id-ID">
	    ...
	    <head>
	    	...
	    	<meta content="<?php echo $site_url; ?>/content/logo/Icon-PMC.png" property="og:image"/>
	    	...
	    	<meta content="@candrarosialda" name="twitter:site"/>
	    	<meta content="@candrarosialda" name="twitter:creator"/>
	    	...
	    	<meta content="<?php echo $site_url; ?>/content/logo/Icon-PMC.png" property="twitter:image"/>
	    	...
	    	<link href="<?php echo $site_url; ?>/Icon-PMC.png" rel="apple-touch-icon"/>
	    	<link href="<?php echo $site_url; ?>/Icon-PMC.png" rel="shortcut icon" type="image/x-icon"/>
	    	<link href="<?php echo $site_url; ?>/content/logo/Icon-PMC.png" rel="icon" sizes="32x32"/>
	    	<meta content="<?php echo $site_url; ?>/content/logo/Icon-PMC.png" name="msapplication-TileImage"/>
	    	<link href="<?php echo $site_url; ?>/content/logo/absensionline180.png" rel="apple-touch-icon"/>
	    	<link href="<?php echo $site_url; ?>/content/logo/Icon-PMC.png" rel="icon" sizes="48x48"/>
	    	<link href="<?php echo $site_url; ?>/content/logo/Icon-PMC.png" rel="icon" sizes="72x72"/>
	    	<link href="<?php echo $site_url; ?>/content/logo/Icon-PMC.png" rel="icon" sizes="96x96"/>
	    	<link href="<?php echo $site_url; ?>/content/logo/Icon-PMC.png" rel="icon" sizes="168x168"/>
	    	<link href="<?php echo $site_url; ?>/content/logo/Icon-PMC.png" rel="icon" sizes="192x192"/>
	    	<link href="<?php echo $site_url; ?>/content/logo/Icon-PMC.png" rel="icon" sizes="512x512"/>
	        				...
	        				<div class="row h-100 justify-content-center align-items-center">
	        					<div class="col-lg-5">
	        						<div class="hero-content text-center text-white">
	        							...
	        							<i aria-hidden="true" class="fa fa-check-circle"></i> Trilogi Techno Expert - IT RS PMC
	        						</div>
	        					</div>
	        					<div class="col-lg-6">
	        						<img style="border-radius: 30px;" src="<?php echo $site_url; ?>/content/logo/Icon-PMC.png" class="img-fluid">
	        					</div>
	        				</div>
	        			</div>
	        		</div>
	        		...
	        		<div class="row">
	        			...
	        			<div class="col-lg-4 col-md-12">
	        				<div class="single-footer-widget pl-5">
	        					...
	        					<ul class="list">
	        						<li><a href="https://mycoding.net" title="Tentang Kami" alt="Tentang Kami">Tentang Kami</a></li>
	        			...
	        			<div class="col-lg-12 col-md-12">
	        				<div class="copyright-area">
	        					Copyright ©2020-2021 <a class="text-white" href="https://mycoding.net"> MC Project</a> by <a class="text-white" href="https://401xd.com"> 401XD Group</a>.
	        				</div>
	        			</div>
	        		</div>
	        	</div>
